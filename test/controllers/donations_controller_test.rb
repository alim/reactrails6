...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { amount: @donation.amount, charity: @donation.charity } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { amount: @donation.amount, charity: @donation.charity } }
